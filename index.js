// index.js (Minimal working ForgeSoul Bot server)
...
webhooks.on("push", async ({ payload }) => {
  ...
  console.log(`🚀 Push received: ${pusher} -> ${owner}/${repo} (${branch})`);
...
// Health check
app.get("/", (_, res) => res.send("✅ ForgeSoul Bot is active"));
...
// Start server
app.listen(PORT, () => {
  console.log(`🟢 ForgeSoul Bot listening on port ${PORT}`);
});
